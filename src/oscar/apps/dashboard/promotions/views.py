...
class CreateRedirectView(generic.RedirectView):
    ...
    def get_redirect_url(self, **kwargs):
        ...
        urls = {}
        for klass in PROMOTION_CLASSES:
            urls[klass.classname()] = reverse('oscar:dashboard:promotion-create-%s' %
                                              klass.classname())
...
class DeletePagePromotionView(generic.DeleteView):
    ...
    def get_success_url(self):
        ...
        return reverse('oscar:dashboard:promotion-list-by-url',
...
class CreateView(PromotionMixin, generic.CreateView):
    ...
    def get_success_url(self):
        ...
        return reverse('oscar:dashboard:promotion-update',
...
class UpdateView(PromotionMixin, generic.UpdateView):
    ...
    def get_success_url(self):
        ...
        return reverse('oscar:dashboard:promotion-list')
        ...
        if form.is_valid():
            ...
            messages.success(request, _("Content block '%(block)s' added to"
                             ...
                             % {'block': promotion.name,
                                'page': page_url})
            return HttpResponseRedirect(reverse('oscar:dashboard:promotion-update',
                                                kwargs=kwargs))
